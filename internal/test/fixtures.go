...
func Fixtures() FixtureMap {
	...
	f.PokemonNotInCollection = &models.Pokemon{
		...
		Speed:       50,
		Special:     20,
		GifURL:      "https://example.com/weedle.gif",
		PNGURL:      "https://example.com/weedle.png",
		Description: "Weedle is a bug Pokémon.",
	}
	...
	f.PokemonInCollection1 = &models.Pokemon{
		...
		Speed:       25,
		Special:     25,
		GifURL:      "https://example.com/kakuna.gif",
		PNGURL:      "https://example.com/kakuna.png",
		Description: "Kakuna is a bug Pokémon.",
	}
	f.PokemonInCollection2 = &models.Pokemon{
		...
		Speed:       56,
		Special:     35,
		GifURL:      "https://example.com/pidgey.gif",
		PNGURL:      "https://example.com/pidgey.png",
		Description: "Pidgey is a normal Pokémon.",
	}
	f.PokemonInCollection3 = &models.Pokemon{
		...
		Speed:       45,
		Special:     55,
		GifURL:      "https://example.com/golem.gif",
		PNGURL:      "https://example.com/golem.png",
		Description: "Golem is a rock Pokémon.",
	}
